import { db, faqsTable, servicesTable, businessesTable } from "@workspace/db";

const BUSINESS_TYPE = (process.env.BUSINESS_TYPE ?? "salon").toLowerCase();

// ─── SALON ───────────────────────────────────────────────────────────────────
const salonFaqs = [
  {
    question: "What are your opening hours?",
    answer: "We are open Monday to Saturday, 9:00 AM – 8:00 PM, and Sunday 10:00 AM – 6:00 PM.",
    keywords: ["hours", "timing", "open", "close", "time", "when", "schedule"],
  },
  {
    question: "Where are you located?",
    answer: "We are located at 45 Main Street, City Center. Easy parking available. Landmark: next to the post office.",
    keywords: ["location", "address", "where", "directions", "map", "place"],
  },
  {
    question: "How do I book an appointment?",
    answer: "You can book by replying with 'book', calling us at +1-555-0101, or visiting our salon. We recommend booking 1 day in advance.",
    keywords: ["book", "appointment", "reserve", "slot", "schedule", "visit"],
  },
  {
    question: "Do you accept walk-ins?",
    answer: "Yes, we do accept walk-ins depending on availability! To avoid waiting, we recommend booking in advance.",
    keywords: ["walk in", "walkin", "without appointment", "drop in", "no booking"],
  },
  {
    question: "What payment methods do you accept?",
    answer: "We accept cash, all major credit/debit cards, and mobile payments (Apple Pay, Google Pay).",
    keywords: ["payment", "pay", "cash", "card", "credit", "debit", "upi", "online"],
  },
  {
    question: "Do you offer home service?",
    answer: "Yes! We offer home service for groups of 3 or more. Extra charges apply. Contact us to arrange.",
    keywords: ["home", "home service", "house", "home visit", "at home", "doorstep"],
  },
  {
    question: "Do you have parking?",
    answer: "Yes, free parking is available right outside our salon.",
    keywords: ["parking", "park", "car", "vehicle"],
  },
  {
    question: "Do you have offers or discounts?",
    answer: "We offer 20% off on your first visit! We also have special weekend packages. Ask our staff for current offers.",
    keywords: ["offer", "discount", "deal", "promo", "promotion", "coupon", "package", "combo"],
  },
];
...
const clinicFaqs = [
  {
    ...
    answer: "Our clinic is open Monday to Friday 8:00 AM – 8:00 PM, Saturday 9:00 AM – 5:00 PM. Closed on Sundays.",
    keywords: ["hours", "timing", "open", "close", "time", "when", "schedule"],
  },
  {
    question: "How do I book a consultation?",
    answer: "Reply 'book appointment' with your preferred date and time, or call us at +1-555-0202. First consultations are 20 minutes.",
    keywords: ["book", "appointment", "consultation", "consult", "doctor", "visit", "schedule"],
  },
  {
    question: "Do you accept insurance?",
    answer: "Yes, we accept most major insurance providers including BlueCross, Aetna, and United Health. Please bring your insurance card.",
    keywords: ["insurance", "cover", "coverage", "plan", "insured"],
  },
  {
    question: "What should I bring to my first appointment?",
    answer: "Please bring a valid ID, your insurance card, any previous medical records, and a list of current medications.",
    keywords: ["bring", "first visit", "documents", "records", "first appointment"],
  },
  {
    question: "Do you offer emergency consultations?",
    answer: "Yes, we reserve slots for same-day emergency consultations. Call us directly for urgent appointments.",
    keywords: ["emergency", "urgent", "same day", "immediate", "asap"],
  },
  {
    question: "Where is the clinic located?",
    answer: "We are at 12 Health Avenue, Medical District. Ground floor, easily wheelchair accessible.",
    keywords: ["location", "address", "where", "directions", "map"],
  },
  {
    question: "Can I get a prescription online?",
    answer: "We offer teleconsultation with e-prescriptions. Book a video call appointment through our system.",
    keywords: ["prescription", "online", "teleconsult", "telemedicine", "video", "remote"],
  },
  {
    question: "What are the consultation fees?",
    answer: "General consultation: $50. Specialist: $120. Teleconsultation: $40. Follow-up visits are discounted.",
    keywords: ["fee", "fees", "cost", "price", "charge", "how much", "consultation fee"],
  },
];
...
const gymFaqs = [
  {
    ...
    answer: "We are open 5:00 AM – 11:00 PM on weekdays and 6:00 AM – 10:00 PM on weekends. 24/7 access available for premium members.",
    keywords: ["hours", "timing", "open", "close", "time", "when", "schedule"],
  },
  {
    question: "How do I sign up for a membership?",
    answer: "Visit us in person or reply 'join' to start your membership. We offer monthly, quarterly, and annual plans. First session is free!",
    keywords: ["join", "sign up", "membership", "register", "enroll", "member"],
  },
  {
    question: "Do you offer personal training?",
    answer: "Yes! We have certified personal trainers available. Sessions start at $40/hour. Reply 'personal trainer' to book.",
    keywords: ["personal trainer", "trainer", "training", "pt", "coach", "one on one"],
  },
  {
    question: "Is there a free trial?",
    answer: "Yes, we offer a free 1-day trial pass. Just visit us with a valid ID and we'll get you started.",
    keywords: ["free", "trial", "try", "demo", "free pass", "guest pass"],
  },
  {
    question: "Do you have group classes?",
    answer: "Yes! We offer Zumba, Yoga, Pilates, Spin, HIIT, and CrossFit classes. Check the schedule at the front desk or ask us.",
    keywords: ["class", "group class", "zumba", "yoga", "pilates", "spin", "hiit", "crossfit"],
  },
  {
    question: "Do you have a swimming pool?",
    answer: "Yes, we have a heated 25m indoor pool. Pool access is included in the Premium membership.",
    keywords: ["pool", "swimming", "swim", "water", "aqua"],
  },
  {
    question: "Can I pause my membership?",
    answer: "Yes, you can pause your membership for up to 2 months per year. Visit the front desk or contact us to arrange.",
    keywords: ["pause", "freeze", "hold", "suspend", "cancel", "stop"],
  },
  {
    question: "What facilities do you have?",
    answer: "We have a fully equipped gym floor, cardio area, free weights, group class studio, steam room, sauna, and lockers.",
    keywords: ["facilities", "equipment", "amenities", "what do you have", "features"],
  },
];
...
const restaurantFaqs = [
  {
    question: "What are your opening hours?",
    answer: "We are open daily: Lunch 12:00 PM – 3:30 PM, Dinner 6:30 PM – 11:00 PM. Last orders 30 mins before closing.",
    keywords: ["hours", "timing", "open", "close", "time", "when", "lunch", "dinner"],
  },
  {
    question: "Do you take reservations?",
    answer: "Yes! Reply 'reserve table' with your preferred date, time, and number of guests. We recommend booking for groups of 4+.",
    keywords: ["reservation", "reserve", "book table", "booking", "table", "seat"],
  },
  {
    question: "Do you offer home delivery?",
    answer: "Yes, we deliver within 5km. Minimum order $20. Delivery charge $3. Average time: 35–45 minutes.",
    keywords: ["delivery", "home delivery", "deliver", "order online", "takeaway", "order"],
  },
  {
    question: "Do you have vegetarian/vegan options?",
    answer: "Absolutely! We have a dedicated vegetarian and vegan menu. Just ask our staff or check the menu section marked 🌱.",
    keywords: ["vegetarian", "vegan", "veggie", "plant based", "no meat", "plant-based"],
  },
  {
    question: "Do you cater for events?",
    answer: "Yes! We offer catering for corporate events, weddings, and private parties. Contact us for custom quotes.",
    keywords: ["catering", "event", "wedding", "party", "corporate", "bulk order"],
  },
  {
    question: "Where are you located?",
    answer: "We are at 88 Food Street, Downtown. Ample street parking available. Look for the red awning!",
    keywords: ["location", "address", "where", "directions", "map", "find us"],
  },
  {
    question: "Do you have a kids menu?",
    answer: "Yes, we have a fun kids menu with smaller portions and kid-friendly options. Kids under 5 eat free!",
    keywords: ["kids", "children", "child", "kids menu", "family"],
  },
  {
    question: "Do you have Wi-Fi?",
    answer: "Yes, free Wi-Fi available! Password is on your table card. Enjoy browsing while you dine.",
...
const coachingFaqs = [
  {
    ...
    answer: "We offer coaching in Math, Science, English, Programming, IELTS/TOEFL, SAT/ACT, MBA entrance, and competitive exam prep.",
    keywords: ["courses", "subjects", "what do you teach", "classes", "offer", "available"],
  },
  {
    question: "What are the batch timings?",
    answer: "Morning batches: 7:00 AM – 10:00 AM. Evening batches: 5:00 PM – 8:00 PM. Weekend batches available. Online classes also offered.",
    keywords: ["timing", "batch", "schedule", "time", "when", "morning", "evening", "weekend"],
  },
  {
    question: "How do I enroll?",
    answer: "Reply 'enroll' with the course name and your contact details, or visit us. A free demo class is included before enrollment.",
    keywords: ["enroll", "join", "admission", "register", "apply", "sign up"],
  },
  {
    question: "Do you offer online classes?",
    answer: "Yes! All our courses are available online via Zoom. Recordings are provided so you never miss a class.",
    keywords: ["online", "zoom", "virtual", "remote", "home", "e-learning", "recorded"],
  },
  {
    question: "What is the fee structure?",
    answer: "Fees vary by course. Group classes start at $80/month. One-on-one tutoring starts at $40/hour. Sibling discounts available.",
    keywords: ["fee", "fees", "cost", "price", "charge", "how much", "payment"],
  },
  {
    question: "Do you offer a free trial class?",
    answer: "Yes! We offer one free demo class for any course. No commitment needed — just come and experience our teaching.",
    keywords: ["free", "trial", "demo", "free class", "try", "sample"],
  },
  {
    question: "What is the student-to-teacher ratio?",
    answer: "Our group batches have max 12 students per teacher to ensure personal attention. One-on-one sessions are also available.",
    keywords: ["ratio", "batch size", "students", "how many students", "class size"],
  },
  {
    question: "Do you provide study material?",
    answer: "Yes! All study materials, practice tests, and worksheets are included in the course fee. No extra charges.",
    keywords: ["material", "study material", "books", "notes", "worksheet", "practice test"],
  },
];
...
// ─── SEED LOGIC ──────────────────────────────────────────────────────────────
type SeedEntry = { faqs: { question: string; answer: string; keywords: string[] }[]; services: { name: string; description: string; price?: number; duration?: number; category: string; keywords: string[] }[] };
const DATA: Record<string, SeedEntry> = {
...
async function resolveBusinessId(): Promise<number> {
  ...
  // When a BUSINESS_TYPE is set, find-or-create a business with the matching name
  const targetName = BUSINESS_NAMES[BUSINESS_TYPE];
  if (targetName) {
    const { eq } = await import("drizzle-orm");
    const [found] = await db
      .select({ id: businessesTable.id })
      .from(businessesTable)
      .where(eq(businessesTable.name, targetName))
      .limit(1);

    if (found) {
      console.log(`Using existing "${targetName}" business id=${found.id}`);
      return found.id;
    }
    ...
    console.log(`Created new "${targetName}" business id=${created!.id}`);
    return created!.id;
  }

  // Fallback: use first existing business or create "My Business"
...
async function seed() {
  ...
  if (!valid.includes(BUSINESS_TYPE)) {
    console.error(`Unknown business type "${BUSINESS_TYPE}". Valid options: ${valid.join(", ")}`);
    process.exit(1);
  }

  const { faqs, services } = DATA[BUSINESS_TYPE];
  const businessId = await resolveBusinessId();

  console.log(`\n🌱 Seeding data for: ${BUSINESS_TYPE.toUpperCase()} (business ${businessId})\n`);
  ...
  for (const svc of services) {
    await db
      ...
      .values({
        ...
        price: svc.price != null ? String(svc.price) : undefined,
  ...
  console.log(`\n🎉 Seed complete! Your bot is ready for ${BUSINESS_TYPE} customers.\n`);
  process.exit(0);
}
